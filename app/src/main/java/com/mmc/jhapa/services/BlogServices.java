...
public class BlogServices {
    ...
    public List<BlogPostModel> getPosts(int limit) {
        ...
        for (int counter = 1; counter <= limit; counter++) {
            blogPosts.add(new BlogPostModel("https://i.natgeofe.com/k/5508021e-2814-42ef-87eb-8dccf24ea9ba/dolphin-communication-leaping.jpg?w=795&h=530", "Mechi multiple campus", "Demo Author", "2022-12-21", "http://ashishneupane.name.np"));
        }
        return blogPosts;
    }
}
